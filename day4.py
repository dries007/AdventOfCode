...
def part1(data):
    return sum(len(line.split()) == len(set(line.split())) for line in data.splitlines())


def part2(data):
    i = 0
    for line in data.splitlines():
        sets = [frozenset(w) for w in line.split()]
...
if __name__ == '__main__':
    input_data = '''bdwdjjo avricm cjbmj ran lmfsom ivsof
