...
def part1(data):
    ...
    for line in data.splitlines():
        reg1, op1, arg1, _, reg2, op2, arg2 = line.split()
        if _ != 'if':
            raise ValueError
        arg1, arg2 = int(arg1), int(arg2)
        print('IF', mem[reg2], op2, arg2, 'THEN', reg1, op1, arg1)
        op1, op2 = _op1[op1], _op2[op2]
        if op2(mem[reg2], arg2):
            mem[reg1] += op1(arg1)
...
c inc -20 if c == 10'''
    ...
    input_data = '''ebu inc 626 if iq < 0
